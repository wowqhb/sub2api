export default {
  ...
  keys: {
    ...
    bulkEdit: {
      ...
      ipHint:
        "One IP or CIDR per line. Leave empty to clear this list on the selected keys.",
      invalidLimit: "Enter a valid amount greater than or equal to 0.",
      invalidExpiration:
        "Choose a valid expiration date or select Never expires.",
      apply: "Apply to {count} keys",
      success: "Updated {count} keys",
      partialFailure: "Updated {success} keys; {failed} failed",
      failureHint:
        "These keys could not be updated. Adjust the settings and retry. Only failed keys will be retried.",
    },
    ...
    useKeyModal: {
      ...
      claudeSettingsHint:
        "User-level persistent configuration. Do not commit this file containing your API key to a project repository.",
      ...
      openai: {
        ...
        authModeDescription:
          "Compatibility mode keeps the existing setup for older Codex clients. API Key Mode authorizes the client-side image executor.",
        authModeLegacy: "Compatibility mode",
        authModeApiKey: "API Key Mode",
        authModeApiKeyRestartNotice:
          "After saving this configuration, completely quit and restart Codex Desktop or CLI, then create a new task so the client can rebuild its tool registry.",
        configTomlHint:
      ...
      grok: {
        ...
        claudeDescription:
          "Configure Claude Code to send Messages API traffic through your Sub2API Grok group.",
        codexDescription:
          "Configure Codex to send Responses API traffic through your Sub2API Grok group.",
        configTomlHint:
      ...
      deepseek: {
        description:
          "Configure Claude Code, Codex, or OpenCode through the current DeepSeek group.",
        codexDescription:
          "Configure Codex with API key authentication through the current DeepSeek group.",
        codexConfigTomlHint:
          "Download the model catalog below, save both files under the Codex config directory, and restart Codex.",
        codexNote:
          "Export SUB2API_API_KEY before starting Codex. The downloaded catalog contains model metadata only, not your API key.",
      },
      minimax: {
        description:
          "Configure Claude Code, Codex, or OpenCode through the current MiniMax group.",
        codexDescription:
          "Configure Codex with API key authentication through the current MiniMax group.",
        codexConfigTomlHint:
          "Download the model catalog below, save both files under the Codex config directory, and restart Codex.",
        codexNote:
          "Export SUB2API_API_KEY before starting Codex. The downloaded catalog contains model metadata only, not your API key.",
      ...
      composite: {
        description:
          "Configure supported clients through the current Composite routing group.",
        codexDescription:
          "Configure Codex with API key authentication and the complete model catalog for this Composite group.",
        codexConfigTomlHint:
          "Download the model catalog below, save both files under the Codex config directory, and restart Codex.",
        codexNote:
          "Export SUB2API_API_KEY before starting Codex. Model requests are routed by the selected catalog slug.",
      },
      routedCodex: {
        description:
          "Configure Codex with the complete model catalog for the current routed group.",
        configTomlHint:
          "Download the model catalog below, save both files under the Codex config directory, and restart Codex.",
      ...
      codexModelCatalog: {
        ...
        description:
          "Fetch with this API key, then save the catalog at the path referenced by config.toml.",
        fetch: "Fetch catalog",
        retry: "Retry",
  ...
  modelPlaza: {
    ...
    detail: {
      ...
      longContextDisabledNote:
        "Long-context tier pricing is disabled for this group: requests above the threshold are billed at the base tier; official tiers are for reference only",
    },
    table: {
      model: "Model",
      input: "Input",
      ...
      tierHintMarginal:
        "Only the portion above the threshold is billed at this tier; output is unaffected",
      ...
      timePricingRowHint:
        "Requests made within this period ({timezone} time) are billed at the prices in this row",
      ...
      timePricingRateHint:
        "Effective rate {rate} × period multiplier {multiplier}",
  ...
  affiliate: {
    ...
    tips: {
      ...
      line2:
        "When invitees recharge, you receive {rate} of the recharge as rebate quota.",
      line3: "Transfer rebate quota to balance at any time.",
      line4:
        "Newly earned rebates may have a waiting period before they can be transferred.",
    },
  },
  ...
  redeem: {
    ...
    userRefreshFailed:
      "Redeemed successfully, but failed to refresh account information.",
  ...
  profile: {
    ...
    passkey: {
      title: "Passkeys",
      description:
        "Use Face ID, Touch ID, Windows Hello, or a security key to sign in without a password.",
      add: "Add passkey",
      ...
      featureDisabled:
        "Passkeys have not been configured by the administrator.",
      ...
      deleteConfirm:
        "Delete “{name}”? You will no longer be able to sign in with it.",

<template>
  <div class="group/usage relative text-sm">
    ...
    >
      <div
        class="mb-1.5 flex items-center justify-between gap-3 border-b border-white/10 pb-1 text-[11px] opacity-80"
      >
        <span>{{ t("admin.users.platformBreakdown") }}</span>
        <span class="font-mono"
          >{{ t("admin.users.today") }} / {{ t("admin.users.total") }}</span
        >
      </div>
      <div
